                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Statistik Lulusan</h6>
                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Grafik Pekerjaan Lulusan</h6>
                                    <div class="dropdown no-arrow">
                                        <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink"
                                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
...
var myLineChart = new Chart(ctx, {
    type: 'line',
    data: {
        labels: {!!json_encode($tahun_kelulusan)!!},
        datasets: [{
            label: "Earnings",
            lineTension: 0.3,
        ...
        tooltips: {
            ...
            callbacks: {
                label: function (tooltipItem, chart) {
                    ...
                    return 'lulus '+ number_format(tooltipItem.yLabel);
                }
            }
        }
    }
